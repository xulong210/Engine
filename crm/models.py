...
class Customer(models.Model):
    ...
    nums_id = models.CharField(verbose_name="身份证号",max_length=64,blank=True,null=True)
    email = models.CharField(verbose_name="邮箱",max_length=64,blank=True,null=True)
    source_choices = (
                        (0,'转介绍'),
                        (1,'QQ群'),
                        (2,'官网'),
    ...
    consultant = models.ForeignKey('UserProfile',on_delete=models.CASCADE) #资讯的销售
...
class CustomerFollowUp(models.Model):
    ...
    intention = models.SmallIntegerField(choices=intention_choices) #跟进客户意向
...
class Course(models.Model):
    ...
    price = models.PositiveSmallIntegerField() #代表正数
    period = models.PositiveSmallIntegerField(verbose_name="周期(月)") #周期 几个月的课程
...
class ClassList(models.Model):
    '''班级列表'''
    branch = models.ForeignKey("Branch",on_delete=models.CASCADE) #所属校区
    course = models.ForeignKey("Course",on_delete=models.CASCADE) #课程名
    class_type_choices = ((0,"面授班"),(1,"面授(周末)"),(2,"网络班"))
...
class Enrollment(models.Model):
    ...
    contract_approval = models.BooleanField(default=False,verbose_name="合同已审核")
    date = models.DateTimeField(auto_now_add=True)
